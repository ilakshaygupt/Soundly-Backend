...
class PlaylistSerializer(serializers.ModelSerializer):
    name = serializers.CharField(
        required=True, error_messages={"required": "Please enter a name"}
    )
    description = serializers.CharField(
        required=True, error_messages={"required": "Please enter a description"}
    )
...
class PlaylistDisplaySerializer(serializers.ModelSerializer):
    ...
    uploader = serializers.CharField(
        required=True, error_messages={"required": "Please enter an uploader"}
    )
    totalduration = serializers.SerializerMethodField()
...
class SongCreateSerializer(serializers.ModelSerializer):
    ...
    language_name = serializers.CharField(
        required=True, error_messages={"required": "Please enter a language"}
    )
    mood_name = serializers.CharField(
        required=True, error_messages={"required": "Please enter a mood"}
    )
    genre_name = serializers.CharField(
        required=True, error_messages={"required": "Please enter a genre"}
    )
    artist_name = serializers.CharField(
        required=True, error_messages={"required": "Please enter an artist"}
    )
...
class SongDisplaySerializer(serializers.ModelSerializer):
    ...
    thumbnail_url = serializers.URLField(
        required=True, error_messages={"required": "Please enter a thumbnail url"}
    )
    artist = serializers.CharField(
        required=True, error_messages={"required": "Please enter an artist"}
    )
    is_private = serializers.BooleanField(
        required=True, error_messages={"required": "Please enter a public status"}
    )
...
class SongSerializer(serializers.ModelSerializer):
    ...
    song_url = serializers.URLField(
        required=True, error_messages={"required": "Please enter an audio url"}
    )
    thumbnail_url = serializers.URLField(
        required=True, error_messages={"required": "Please enter a thumbnail url"}
    )
    ...
    song_duration = serializers.CharField(required=False)
    lyrics_json = serializers.JSONField(required=False)
...
class artistSerializer(serializers.ModelSerializer):
    ...
    thumbnail_url = serializers.URLField(
        required=False, error_messages={"required": "Please enter a thumbnail url"}
    )
