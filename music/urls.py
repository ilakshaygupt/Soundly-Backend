...
urlpatterns = [
    ...
    path('api/songs/<int:pk>/', views.SongAPI.as_view(),
    ...
    path('api/playlists/<int:pk>/', views.PlaylistAPI.as_view(),
         name='playlist-view'),  # put path delete or get a single playlist by id
    path('api/playlists/<int:pk>/songs/', views.PlaylistSongAPI.as_view(),
         name='playlist-song-view'),  # display all songs in users's playlist
    path('api/playlists/<int:pk>/songs/<int:song_pk>/', views.AddSongToPlaylistAPI.as_view(),
